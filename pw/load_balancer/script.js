...
function stepForward() {
    ...
    let newState = mainLoop(currentState);
    stateHistory.push(JSON.parse(JSON.stringify(newState)));
    currentState = newState;
}

function stepBackwards() {
    console.log('stepBackwards, currentState : ', currentState);
...
function onButtonResetClick() {
    ...
    currentState = JSON.parse(JSON.stringify(generatedState));
...
window.onload = () => {
    ...
    currentState = JSON.parse(JSON.stringify(generatedState));
    stateHistory = [JSON.parse(JSON.stringify(currentState))];
